package com.pb.bolshakov.test.qwer;
import java.io.*;
import java.net.*;
...
class ServerSomthing extends Thread {
    ...
    public ServerSomthing(Socket socket) throws IOException {
        ...
        Story.Server.story.printStory(out); // поток вывода передаётся для передачи истории последних 10
        ...
        try {
            ...
            try {
                while (true) {
                    ...
                    Story.Server.story.addStoryEl(word);
                    for (ServerSomthing vr : Story.Server.serverList) {
        ...
        try {
            if(!socket.isClosed()) {
                ...
                for (ServerSomthing vr : Story.Server.serverList) {
                    ...
                    Story.Server.serverList.remove(this);
                }
            }
        } catch (IOException ignored) {}
    }
